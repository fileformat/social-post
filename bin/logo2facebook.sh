...
echo "${SVGDATA}" | ${RSVG} --background-color=white --width=1600 --dpi-x=600 --keep-aspect-ratio --format png --output "${PNGFILE}"
...
${SOCIAL_POST} facebook --image="${PNGFILE}" --image-caption="${NAME} Logo" "Logo for ${NAME} https://vlz.one/${LOGOHANDLE}"
